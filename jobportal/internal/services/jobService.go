...
func (s *Conn) AddJobs(jobs []models.Job, compId string) ([]models.Job, error) {
...
func (s *Conn) FetchJobByCompanyId(ctx context.Context, companyId string) ([]models.Job, error) {
...
func (s *Conn) GetJobById(ctx context.Context, jobId string) (models.Job, error) {
...
func (s *Conn) GetAllJobs(ctx context.Context) ([]models.Job, error) {
